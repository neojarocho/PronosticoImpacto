	...
	<!-- CONTENIDO DATA -->
		...
		<!-- ----------------------------------------------------------------------------------------- -->
		        <div  class="col-md-12" id="TomarAccion" style="padding-left: 0px; padding-right: 0px; padding-right: 15px; margin-bottom: -20;">
		                    ...
		                    <table class="table table-bordered"> 
		                        <caption style="background: #F20505; text-align: left; color: #ffffff ;font-size: 15px !important; padding-left: 10px;"><b>TOMAR ACCIÓN</b></caption>
		...
		<!-- ----------------------------------------------------------------------------------------- -->
		        ...
		        <div  class="col-md-12" id="EstarPreparados" style="padding-left: 0px; padding-right: 0px; padding-right: 15px; margin-bottom: -20;">
		                    ...
		                    <table class="table table-bordered"> 
		                        <caption style="background: #f29e05; color: #ffffff; text-align: left; font-size: 15px !important; padding-left: 10px;"><b>PREPARACIÓN</b></caption>
		                        <tr style="background:#EEEEEE" align="center"></tr>  
		                        <?php  
		...
		<!-- ----------------------------------------------------------------------------------------- -->
		        ...
		        <div  class="col-md-12" id="EstarInformados" style="padding-left: 0px; padding-right: 0px; padding-right: 15px; margin-bottom: -20;">
		                    <table class="table table-bordered"> 
		                        <caption style="background: #ffef00; color: #5b5b5b; text-align: left; font-size: 15px; padding-left: 10px;"><b>ATENCIÓN</b></caption>
		                        <tr style="background:#EEEEEE" align="center"></tr>  
		                        <?php  
		...
		<!-- ----------------------------------------------------------------------------------------- -->
		        ...
		        <div  class="col-md-12" id="CondicionesNormales" style="padding-left: 0px; padding-right: 0px; padding-right: 15px; margin-bottom: -20;">
							 <table class="table table-bordered"> 
		                        <caption style="background: #6ab93c; color: #ffffff; text-align: left; font-size: 15px; padding-left: 10px;"><b>VIGILANCIA</b></caption>
		                        <tr style="background:#EEEEEE" align="center"></tr>  
		                        <?php  
